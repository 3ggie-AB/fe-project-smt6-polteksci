          ...
          <section className="max-w-3xl space-y-5">
            ...
            <div className="space-y-3">
              ...
              <p className="max-w-2xl text-sm leading-relaxed text-muted-foreground md:text-base">
                Backend observability jaringan untuk device metadata, realtime SSE, notification, dan ML-ready
                feature vector. Frontend ini terhubung ke {API_ORIGIN}.
              </p>
            </div>
